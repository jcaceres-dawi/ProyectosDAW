                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('expense.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="expense_date" id="expense_date" value="{{ old('expense_date') }}"
                                class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="checkbox" name="is_paid" id="is_paid" value="1" @checked(old('is_paid') == 1)
                        ...
                        <x-primary-button class="mt-4">{{ __('Crear gasto') }}</x-primary-button>
